...
<body>
			...
			<div class="col-md-4 col-sm-4 col-xs-12">
				<form class="form-container" method="post">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="InputUsername" name="OT_username" placeholder="Alphabetical characters only" />
					</div>
					<div class="form-group">
						<label for="InputEmail1">Email</label>
						<input type="text" class="form-control" id="InputEmail1" aria-describedby="emailHelp" placeholder="Profile page" name="OT_FacebookLink">
					</div>
					<div class="form-group">
						<label for="InputPassword1">New Password</label>
						<input type="password" class="form-control" id="InputPassword1" name="OT_password" placeholder="8-12 Characters, Aplhanumeric Only">
					</div>
					<div class="form-group">
	...
	if (isset($_POST['submit'])) {
		...
		if ($password1 == $password2) {
			...
			$sql = "INSERT INTO operationteam (Username, password, Email) VALUES ('$username','$password2','$FB_Link')";
			// execute query
